...
COMPOSE_FILE_PATH="/app/compose/installed/dockge/docker-compose.yaml"
...
rm /app/compose/installed/dockge/.env

echo "Step 4: Moving configuration..."
mv /app/compose/installed/dockge /app/compose/not_installed/
